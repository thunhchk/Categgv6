	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Người mẫu huấn luyện tự động",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Tự động mở khóa bột khoai tây chiên",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Chip mở khóa tự động Phoenix",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Chấp nhận Rainbow Quest nhanh hơn",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Quan sát trang trại tự động",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Tự động nâng cấp Mink V3",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Tự động nâng cấp Human V3",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Tự động nâng cấp Fishman V3",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Initialize = Tabs.Settings:AddToggle("Initialize", {
		Title = "un ban đánh quái không được",
		Description = "un ban thinh-hoang premium",
		Default = true
	})
	...
	local Byp = Tabs.Settings:AddToggle("Byp", {
		Title = "Bật Bỏ qua dịch chuyển tức thời",
		Description = "",
		Default = false
	})
	...
	local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {
		Title = "Xóa VFX khi chết và hồi sinh",
		Description = "",
		Default = false
	})
	DisblesVFX:OnChanged(function(Value)
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "Dừng lại khi đã có được Chén Thánh của Chúa",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Quests:AddButton({
		Title = "Buy Thanh kiếm huyền thoại",
		Description = "",
		Callback = function()
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "Tự động chuyển sang điểm cao nhất",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "Thay đổi minh bạch có thể thấy",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "Đàn Guitar Đầu Lâu Auto Farm Material",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "Tự động nhìn vào mặt trăng",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Mirage:AddButton({
		Title = "Dịch chuyển đến Đền thờ Thời gian",
		Description = "",
		Callback = function()
	...
	Tabs.Mirage:AddButton({
		Title = "Dịch chuyển đến Ancient One",
		Description = "",
		Callback = function()
	...
	Tabs.Mirage:AddButton({
		Title = "Dịch chuyển đến Đồng hồ cổ",
		Description = "",
		Callback = function()
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "Tự động dịch chuyển đến Cửa đua",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "Cuộc đua thử nghiệm tự động hoàn thành",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "Tự động giết người chơi trong thử thách",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local DojoQ = Tabs.Drago:AddToggle("DojoQ", {
		Title = "Huấn luyện viên Auto Dojo",
		Description = "bật để làm nhiệm vụ đai dojo từ trắng sang đen",
		Default = false
	})
	...
	local BlazeEM = Tabs.Drago:AddToggle("BlazeEM", {
		...
		Description = "bật để farm blaze ember + tự động thu thập blaze ember",
		Default = false
	})
	...
	Toggle = Tabs.Drago:AddToggle("Toggle", {
		Title = "Tween sẽ nâng cấp bản dùng thử Droco",
		Description = "",
		Default = false
	})
	Toggle:OnChanged(function(Value)
	...
	Toggle = Tabs.Drago:AddToggle("Toggle", {
		Title = "Auto Drago (V1)",
		Description = "bật cho nhiệm vụ tự động 1 sự kiện tiền sử tự động + thu thập trứng rồng",
		Default = false
	})
	Toggle:OnChanged(function(Value)
		_G.DragoV1 = Value
	...
	local fireflower = Tabs.Drago:AddToggle("fireflower", {
		Title = "Auto Drago (V2)",
		Description = "bật để tự động tiêu diệt Cướp biển rừng & Thu thập hoa lửa",
		Default = false
	})
	...
	Toggle = Tabs.Drago:AddToggle("Toggle", {
		Title = "Auto Drago (V3)",
		Description = "bật cho sự kiện trên biển giết chết cá mập khủng bố",
		Default = false
	})
	Toggle:OnChanged(function(Value)
		_G.DragoV3 = Value
	...
	local UpTalon = Tabs.Drago:AddToggle("UpTalon", {
		Title = "Nâng cấp Dragon Talon với Uzoth",
		Description = "",
		Default = false
	})
	...
	Toggle = Tabs.Prehistoric:AddToggle("Toggle", {
		Title = "Nam châm núi lửa tự động chế tạo",
	...
	Tabs.Prehistoric:AddButton({
		Title = "Nam châm núi lửa thủ công",
		Description = "",
		Callback = function()
	...
	Toggle = Tabs.Prehistoric:AddToggle("Toggle", {
		Title = "Tự động thiết lập lại khi hoàn thành núi lửa",
		Description = "",
		Default = false
	})
	Toggle:OnChanged(function(Value)
	...
	local FloD = Tabs.SeaEvent:AddParagraph({
		Title = " Trạng thái FlozenDimension ",
		Content = ""
	})
	spawn(function()
		pcall(function()
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Lái xe tự động đến Đảo Hydra",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Tự động dịch chuyển đến Đền thờ được kích hoạt",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Tự động thu thập Azure Ember",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Giao dịch tự động Azure Ember",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.SeaEvent:AddButton({
		Title = "Mặt hàng thương mại Azure",
		Description = "",
		Callback = function()
			replicated.Modules.Net:FindFirstChild("RF/KitsuneStatuePray"):InvokeServer()
		end
	...
	Tabs.SeaEvent:AddButton({
		Title = "Nói chuyện với bức tượng kitsune",
		Description = "",
		Callback = function()
			replicated.Modules.Net:FindFirstChild("RE/TouchKitsuneStatue"):FireServer()
		end
	...
	local Q = Tabs.Raids:AddToggle("Q", {
		Title = "Tự động chọn chip ngục tối",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Raids:AddButton({
		Title = "Mua Chips [Trái ác quỷ]",
		Description = "Sử dụng loại trái cây ít nhất trong túi của bạn",
		Callback = function()
...
Q = Tabs.Raids:AddToggle("Q", {
    Title = "Tự động hoàn thành cuộc đột kích [An toàn]",
    Description = "",
    Default = false
})
Q:OnChanged(function(Value)
...
spawn(function()
	...
	Q = Tabs.Combat:AddDropdown("Q", {
		Title = "Chọn phương pháp nhắm mục tiêu",
		Values = AimbotMethod,
		Multi = false,
		Default = 1
	})
	...
	Q = Tabs.Combat:AddToggle("Q", {
		...
		Description = "Kỹ năng phương pháp Aimbot",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.AimMethod = Value
	...
	Q = Tabs.Combat:AddToggle("Q", {
		...
		Description = "bật để tạo mink v3 vô cực",
		Default = false
	})
	Q:OnChanged(function(Value)
		InfAblities = Value
	...
	Q = Tabs.Combat:AddToggle("Q", {
		...
		Description = "bật để tạo ra năng lượng vô hạn",
		Default = false
	})
	Q:OnChanged(function(Value)
		infEnergy = Value
	...
	Q = Tabs.Combat:AddToggle("Q", {
		...
		Description = "bật để làm cho phạm vi quan sát vô cực",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.Combat:AddToggle("Q", {
		Title = "Bỏ qua các đội giống nhau",
	...
	if World3 then
		...
		Q = Tabs.Combat:AddToggle("Q", {
			Title = "Đại lý trái cây cao cấp Esp",
			Description = "",
			Default = false
		})
		Q:OnChanged(function(Value)
	...
	Tabs.Travel:AddButton({
		Title = "Du lịch East Blue (Thế giới 1)",
		Description = "",
		Callback = function()
	...
	Tabs.Travel:AddButton({
		Title = "Du lịch Dressrosa (Thế giới 2)",
		Description = "",
		Callback = function()
			replicated.Remotes.CommF_:InvokeServer("TravelDressrosa")
		end
	...
	GoIsland = Tabs.Travel:AddToggle("GoIsland", {
		Title = "Du lịch bằng ô tô",
		Description = "Tự động dịch chuyển đến đảo pos",
		Default = false
	})
