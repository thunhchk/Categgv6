	...
	local Window = Fluent:CreateWindow({
		Title = "cat egg v6 beta",
		SubTitle = "  by thinh-hoang",
		TabWidth = 160,
		Theme = "Light",
		Acrylic = false,
	...
	toggleButton.Image = "rbxassetid://71929667640689"
	...
	Tabs.tiktok:AddButton({
		Title = "Link tiktok nha các anh em",
		Description = "Đây nha anh em ( Copy rồi dán vào google)",
		Callback = function()
			setclipboard(tostring("https://www.tiktok.com/@nguyenphuocthinh281989"))
		end
	})
	local ReplicatedStorage = game:GetService("ReplicatedStorage")
	local Players = game:GetService("Players")
	if World3 then
		Tabs.Main:AddSection("cat egg v5 update ngon")
	...
	local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {
		...
		Description = "Farm level cày cấp",
		Default = false
	})
	...
	local MasteryGun = Tabs.Main:AddToggle("MasteryGun", {
		...
		Description = "cày thông thạo súng",
		Default = false
	})
	...
	local MasterySword = Tabs.Main:AddToggle("MasterySword", {
		...
		Description = "cày thông thạo kiếm",
		Default = false
	})
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "gương trang trại tự động",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.AutoMiror = Value
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "đánh boss lấy lưỡi hái",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Bia mộ tự động thử vận may",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.TryLucky = Value
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Tự động mở khóa ngục tối Dough",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.Doughv2 = Value
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Tự động mở khóa ngục tối Phượng Hoàng",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Auto dịch chuyển Barista Cousin",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "haki cầu vòng tự động",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Chấp nhận nhiệm vụ cầu vồng nhanh hơn",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.GetQFast = Value
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "auto farm haki quang xác",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.obsFarm = Value
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "auo farm haki quang xác v2",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Tự động nâng cấp Mink V3",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.Auto_Mink = Value
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Tự động nâng cấp Human V3",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.Auto_Human = Value
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Tự động nâng cấp Skypiea V3",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Tự động nâng cấp FishMan V3",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.Auto_Fish = Value
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Tự động mở khóa câu đố",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.AutoUnHaki = Value
	...
	local Initialize = Tabs.Settings:AddToggle("Initialize", {
		Title = "un ban quái đánh không được",
		Description = "un ban thinh-hoang",
		Default = true
	})
	...
	local RandomAround = Tabs.Settings:AddToggle("RandomAround", {
		...
		Description = "động bật vị trí quay",
		Default = false
	})
	...
	local Byp = Tabs.Settings:AddToggle("Byp", {
		...
		Description = "Bật dịch chuyển tức thời",
		Default = false
	})
	...
	local SafeModes = Tabs.Settings:AddToggle("SafeModes", {
		Title = "Chế độ hoảng loạn",
		Description = "bật để đảm bảo sức khỏe của bạn nếu thấp",
		Default = false
	})
	...
	local UnDetectedAFK = Tabs.Settings:AddToggle("UnDetectedAFK", {
		Title = "chống AFK",
		Description = "dành cho ae treo game",
		Default = true
	})
	...
	local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {
		...
		Description = "Xóa hiệu ứng hình ảnh khi bị đánh",
		Default = false
	})
	...
	local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {
		...
		Description = "Xóa hiệu ứng tử vong và hồi sinh",
		Default = false
	})
	DisblesVFX:OnChanged(function(Value)
		RDeath = Value
	...
	local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {
		...
		Description = "Vô hiệu hóa thông báo",
		Default = false
	})
	DisblesVFX:OnChanged(function(Value)
		RemoveDamage = Value
	...
	local StatusSelect = Tabs.Settings:AddSlider("StatusSelect", {
		Title = "Stats Value",
		Description = "Chọn loại kĩ năng cần cộng điểm",
		Default = 10,
		Min = 0,
		Max = 1000,
		Rounding = 1,
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "Dừng lại khi có được Chén Thánh của Chúa",
		Default = true
	})
	Q:OnChanged(function(Value)
	...
	local CheckCDK = Tabs.Quests:AddParagraph({
		Title = " Số nhiệm vụ kiếm katana đôi bị nguyền rủa ",
		Content = "Số nhiệm vụ :"
	})
	spawn(function()
		while wait(.2) do
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "Tự động nhận CDK [ Nhiệm vụ cuối cùng ]",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.CDK = Value
	...
	Tabs.Quests:AddButton({
		...
		Description = "Mua thanh kiếm Katana ba chân chính",
		Callback = function()
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "Từ người bán kiếm huyền thoại trở lên"",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.Tp_LgS = Value
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "thanh kiếm tự động bảo vệ",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.WardenBoss = Value
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "Lớp phủ tự động hàng hải",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "Áo khoác thiên nga tự động",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.SwanCoat = Value
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "tự động lấy yoru v3",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "Kiếm tự động Canvendish",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Quests:AddToggle("Q", {
		...
		Description = "Phụ kiện vòng đeo tay ô tô",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.AutoKilo = Value
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "tự động tìm Đảo Mirage",
		Description = "bật để tìm & đảo Mirage",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.FindMirage = Value
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		...
		Description = "Tự động chuyển sang điểm cao nhất",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		...
		Description = "Thay đổi minh bạch có thể nhìn thấy",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.can = Value
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		...
		Description = "auto nhặt rương ở đảo mirage",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.FarmChestM = Value
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		...
		Description = "Đàn Guitar Đầu Lâu Vật Liệu Auto Farm",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		...
		Description = "tự động nhìn vào mặt trăng",
		Default = false
	})
	Q:OnChanged(function(Value)
		LookM = Value
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		Title = "Auto Train V4",
		Description = "Tàu hỏa tự động V4"",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.AcientOne = Value
	...
	Tabs.Mirage:AddButton({
		...
		Description = "Dịch chuyển đến Đền thờ Thời gian",
		Callback = function()
	...
	Tabs.Mirage:AddButton({
		...
		Description = "Dịch chuyển đến Đồng hồ cổ đại",
		Callback = function()
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		...
		Description = "động dịch chuyển đến Cửa đua",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.TPDoor = Value
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		...
		Description = "Cuộc đua thử nghiệm hoàn chỉnh tự động",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Mirage:AddToggle("Q", {
		...
		Description = Tự động giết người chơi sau khi thử nghiệm",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.Defeating = Value
	...
	local DojoQ = Tabs.Drago:AddToggle("DojoQ", {
		Title = "Người huấn luyện Auto Dojo",
		Description = "bật nhiệm vụ làm đai dojo từ trắng sang đen",
		Default = false
	})
	...
	local BlazeEM = Tabs.Drago:AddToggle("BlazeEM", {
		Title = "Thợ săn rồng tự động",
		Description = "bật để kiếm than hồng + tự động thu thập than hồng",
		Default = false
	})
	...
	Toggle = Tabs.Drago:AddToggle("Toggle", {
		...
		Description = "Tween sẽ nâng cấp bản dùng thử Droco",
		Default = false
	})
	Toggle:OnChanged(function(Value)
		_G.UPGDrago = Value
	...
	Toggle = Tabs.Drago:AddToggle("Toggle", {
		Title = "Auto Drago (V1)",
		Description = "bật cho nhiệm vụ tự động 1 thời tiền sử",
		Default = false
	})
	Toggle:OnChanged(function(Value)
		_G.DragoV1 = Value
	...
	local fireflower = Tabs.Drago:AddToggle("fireflower", {
		Title = "Auto Drago (V2)",
		Description = "để tự động tiêu diệt Cướp biển Rừng & Thu thập hoa lửa",
		Default = false
	})
	...
	Toggle = Tabs.Drago:AddToggle("Toggle", {
		Title = "Auto Drago (V3)",
		Description = "bật sự kiện biển tiêu diệt khủng bố cá mập",
		Default = false
	})
	Toggle:OnChanged(function(Value)
		_G.DragoV3 = Value
	...
	local bdrago = Tabs.Drago:AddToggle("bdrago", {
		...
		Description = "Hoán đổi chủng tộc Drago",
		Default = false
	})
	...
	Toggle = Tabs.Prehistoric:AddToggle("Toggle", {
		Title = "Tự động chế tạo nam châm núi lửa",
		Description = "bật để tự động kiếm nguyên liệu và chế tạo nam châm núi lửa & dừng lại khi bạn có 1 nam châm núi lửa",
		Default = false
	})
	Toggle:OnChanged(function(Value)
		_G.CraftVM = Value
	...
	Tabs.Prehistoric:AddButton({
		...
		Description = "Nam châm núi lửa thủ công",
		Callback = function()
	...
	local Check_Volcano = Tabs.Prehistoric:AddParagraph({
		Title = " Tình trạng đảo thời tiền sử ",
		Content = ""
	})
	spawn(function()
		while wait(.2) do
	...
	Vocan = Tabs.Prehistoric:AddToggle("Vocan", {
		Title = "Tự động tìm đảo thời tiền sử",
		Description = "bật để tìm & chuyển đổi & bắt đầu hòn đảo thời tiền sử",
		Default = false
	})
	...
	local Vocan = Tabs.Prehistoric:AddToggle("Vocan", {
		Title = "Sự kiện thời tiền sử tự động vá",
		Description = "bật để tự động vá núi lửa tiêu diệt golem dung nham hào quang tự động loại bỏ dung nham",
		Default = false
	})
	Vocan:OnChanged(function(Value)
	...
	Toggle = Tabs.Prehistoric:AddToggle("Toggle", {
		Title = "Tự động thiết lập lại khi núi lửa hoàn thành",
		Description = "Đặt lại khi hoàn thành Núi lửa không thu thập được xương khủng long và các thứ khác..",
		Default = false
	})
	Toggle:OnChanged(function(Value)
		_G.ResetPH = Value
	...
	Tabs.SeaEvent:AddButton({
		Title = "mua phân mảnh với spy",
		Description = Mua điệp viên để tìm ra leviathan",
		Callback = function()
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		Title = "Tự động dịch chuyển đến chiều không gian đóng băng",
		Description = "bật để dịch chuyển đến chiều không gian đóng băng và khởi động cổng Leviathan",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.FrozenTP = Value
	...
	Tabs.SeaEvent:AddButton({
		Title = "Buy thuyền",
		Description = "Mua thuyền được chọn",
		Callback = function()
			replicated.Remotes.CommF_:InvokeServer("BuyBoat", _G.SelectedBoat)
		end
	})
	local Q = Tabs.SeaEvent:AddDropdown("Q", {
		Title = "Chọn mực nước biển",
		Values = ListSeaZone,
		Multi = false,
		Default = 1
	})
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		...
		Description = "Tự động dịch chuyển đến Đền thờ đã được kích hoạt",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		...
		Description = "Tự động thu thập Azure Ember"",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.SeaEvent:AddToggle("Q", {
		...
		Description = "Tự động giao dịch Azure Ember"",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.SeaEvent:AddButton({
		...
		Description = "Mặt hàng thương mại Azure",
		Callback = function()
			replicated.Modules.Net:FindFirstChild("RF/KitsuneStatuePray"):InvokeServer()
		end
	})
	Tabs.SeaEvent:AddButton({
		...
		Description = "Nói chuyện với bức tượng kitsune",
		Callback = function()
			replicated.Modules.Net:FindFirstChild("RE/TouchKitsuneStatue"):FireServer()
		end
	})
	...
	Tabs.Raids:AddButton({
		Title = "Buy Chips bằng [Devil Fruit]",
...
Q = Tabs.Raids:AddToggle("Q", {
    ...
    Description = "Tự động hoàn tất cuộc đột kích",
    Default = false
})
Q:OnChanged(function(Value)
    _G.Raiding = Value
...
spawn(function()
	...
	local Q = Tabs.Raids:AddToggle("Q", {
		...
		Description = "Đảo tiếp theo tự động",
		Default = false
	})
	Q:OnChanged(function(Value)
		NextIs = Value
	...
	__indexPlayer = Tabs.Combat:AddParagraph({
		Title = "Tất cả người chơi trên máy chủ :",
		Content = ""
	})
	spawn(function()
		while wait(Sec) do
	...
	Q = Tabs.Combat:AddToggle("Q", {
		Title = "Dịch chuyển tức thời để chọn người chơi",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.Combat:AddToggle("Q", {
		Title = Khán giả chọn người chơi",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.Combat:AddToggle("Q", {
		Title = Kỹ năng phương pháp Aimbot",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.Combat:AddToggle("Q", {
		...
		Description = "bật để tạo mink v3 vô hạn",
		Default = false
	})
	Q:OnChanged(function(Value)
		InfAblities = Value
	...
	Q = Tabs.Combat:AddToggle("Q", {
		...
		Description = "bật để tạo ra năng lượng vô cực",
		Default = false
	})
	Q:OnChanged(function(Value)
		infEnergy = Value
	...
	Q = Tabs.Combat:AddToggle("Q", {
		...
		Description = "bật để tạo soru vô cực",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.InfSoru = Value
	...
	Q = Tabs.Combat:AddToggle("Q", {
		...
		Description = "bật để có phạm vi quan sát vô cực",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Q = Tabs.Combat:AddToggle("Q", {
		...
		Description = "bật để bỏ qua không phải aimbot cùng đội",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.NoAimTeam = Value
	...
	Q = Tabs.Combat:AddToggle("Q", {
		Title = "Accept Allies",
		Description = "bật để tự động chấp nhận đồng minh",
		Default = false
	})
	Q:OnChanged(function(Value)
		_G.AcceptAlly = Value
	...
	GoIsland = Tabs.Travel:AddToggle("GoIsland", {
		Title = "Auto Travel",
		Description = "tự động dịch chuyển đến đảo",
		Default = false
	})
	...
	Tabs.Server:AddButton({
		Title = "Vào SERVER VIP FREE",
		Description = có khi hết sài đc roi",
		Callback = function()
			task.spawn(function()
	...
	Tabs.Server:AddButton({
		...
		Description = "Nhảy đến người chơi thấp nhất",
		Callback = function()
	...
	Tabs.Server:AddButton({
		...
		Description = "Chuyển đến máy chủ có Ping thấp nhất",
		Callback = function()
			local HTTPService = game:GetService("HttpService")
			local TeleportService = game:GetService("TeleportService")
			local StatsService = game:GetService("Stats")
			local function fetchServersData(placeId, limit)
				local url = string.format("https://games.+.com/v1/games/%d/servers/Public?limit=%d", placeId, limit)
				local success, response = pcall(function()
	...
	Tabs.Misc:AddButton({
		...
		Description = "Chuyên gia Awakenings mở",
		Callback = function()
	...
	Tabs.Misc:AddButton({
		...
		Description = "Mở lựa chọn tiêu đề",
		Callback = function()
	...
	DisbleChat = Tabs.Misc:AddToggle("DisbleChat", {
		...
		Description = "Vô hiệu hóa GUI trò chuyện",
		Default = false
	})
	...
	DisbleLeaderB = Tabs.Misc:AddToggle("DisbleLeaderB", {
		...
		Description = "Vô hiệu hóa GUI Bảng xếp hạng",
		Default = false
	})
	...
	Tabs.Misc:AddButton({
		...
		Description = "Thiết lập đội cướp biển",
		Callback = function()
			Pirates()
		end
	})  
	Tabs.Misc:AddButton({
		...
		Description = "thiết lập đội hải quân",
		Callback = function()
			Marines()
		end
	})
	UnPortal = Tabs.Misc:AddToggle("UnPortal", {
		Title = Mở khóa tất cả các cổng",
		Description = "cổng mở khóa dành cho người không đánh bại được rip_indra",
		Default = false
	})
	...
	Tabs.Misc:AddButton({
		...
		Description = "Xóa sương mù trên bầu trời",
		Callback = function()
	...
	Tabs.Misc:AddButton({
		...
		Description = "",
		Callback = function()
			for i, v in pairs(game:GetObjects("rbxassetid://71929667640689")[1]:GetChildren()) do
	...
	briggt1 = Tabs.Misc:AddToggle("briggt1", {
		...
		Description = "Bật chế độ sáng tối đa",
		Default = false
	})
	...
	walkWater = Tabs.Misc:AddToggle("walkWater", {
		Title = "Bật chế độ Đi bộ trên mặt nước",
	...
	iceWalk = Tabs.Misc:AddToggle("iceWalk", {
		Title = "Bật Ice Walk",
		Description = "Đi trên băng giống như đi trên mặt nước nhưng có hiệu ứng băng",
		Default = false
	})
